...
/*=========================================================================
  ...
  Module:    $RCSfile: vtkVJWin32OpenGLRenderWindow.h,v $
...
#ifndef __vtkVJWin32OpenGLRenderWindow_h
#define __vtkVJWin32OpenGLRenderWindow_h
...
class VTK_RENDERING_EXPORT vtkVJWin32OpenGLRenderWindow : public vtkVJRenderWindow
{
public:
  static vtkVJWin32OpenGLRenderWindow *New();
  vtkTypeRevisionMacro(vtkVJWin32OpenGLRenderWindow,vtkVJRenderWindow);
...
private:
  vtkVJWin32OpenGLRenderWindow(const vtkVJWin32OpenGLRenderWindow&);  // Not implemented.
  void operator=(const vtkVJWin32OpenGLRenderWindow&);  // Not implemented.
