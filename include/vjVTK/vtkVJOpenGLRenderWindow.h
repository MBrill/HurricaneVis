...
/*=========================================================================
  ...
  Module:    $RCSfile: vtkVJOpenGLRenderWindow.h,v $
  Language:  C++
...
#ifndef __vtkVJOpenGLRenderWindow_h
#define __vtkVJOpenGLRenderWindow_h
...
{
public:
  static vtkVJOpenGLRenderWindow *New();
  vtkTypeRevisionMacro(vtkVJOpenGLRenderWindow,vtkVJRenderWindow);
...
protected:
  ...
  vtkVJOpenGLRenderWindowInternal *Internal;
...
private:
  vtkVJOpenGLRenderWindow(const vtkVJOpenGLRenderWindow&);  // Not implemented.
  void operator=(const vtkVJOpenGLRenderWindow&);  // Not implemented.
